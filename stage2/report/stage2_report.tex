...
returns alone, delivers only the physical forecast. \citet{liu2015} document the same shortfall and read it the same
way, reporting their GARCH-computed VIX 20--30\% below the market VIX before September
2003 and 10--13\% below afterwards. The 22\% here exceeds that post-2003 figure, which
is the relevant comparison for a 2012--2026 sample; they also compare a one-day-ahead
GARCH \emph{forecast} of VIX rather than annualised conditional volatility. GARCH exceeds VIX on the remaining 13.3\% of
...
in logarithms, ranging across four-year sub-periods from 0.663 (2012--2015) to 0.889
(2020--2022) --- strongest in the turbulent window, weakest in the calm stretches. In
...
(Pearson 0.833, ranging 0.663--0.889 across four-year sub-periods), hardly at all in
daily changes ($-0.007$). The lead--lag correlation of
